 ...
 * 4. Usar criterio de aspiración para permitir movimientos tabú si mejoran la mejor solución
    ...
    public Solution solve(Environment env) {
        ...
        for (int i = 1; i <= maxIterations; i++) {
            ...
            if (currentSolution.getTotalCost() < bestSolution.getTotalCost()) {
                ...
                System.out.println("Iteration " + i + ": New best solution found with cost " + bestSolution.getTotalCost());
            }
